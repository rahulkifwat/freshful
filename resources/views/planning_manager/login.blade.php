...
<head>
    ...
    <title>Planning Manager Login | {{ config('app.name','Freshful') }}</title>
    ...
    <style>
        ...
        .login-header { background:#17a2b8; color:#fff; border-radius:8px 8px 0 0; padding:28px 32px 20px; text-align:center; }
        .login-header h4 { margin:0; font-size:22px; }
        .login-body { padding:28px 32px; }
        .btn-login { background:#17a2b8; border:none; color:#fff; width:100%; padding:10px; font-size:16px; border-radius:5px; }
        .btn-login:hover { background:#138496; color:#fff; }
    </style>
</head>
<body>
<div class="login-card">
    ...
    <div class="login-body">
        ...
        @endif
        <form method="POST" action="{{ route('planning_manager.login_submit') }}">
            @csrf
