  ...
  <div class="contents-inner">
    <div class="row"><div class="full-wdt"><div class="contents-inner"><div class="row"><div class="col-12">
      <div class="section-content">
        <div class="content-head"><h4 class="content-title">Ratings & Reviews</h4></div>
        <div class="content-details show">
          @if($rows instanceof \Illuminate\Support\Collection && $rows->isEmpty())
            <div class="alert alert-info">No reviews table found or no records yet.</div>
          @else
                ...
                @forelse($rows as $r)
                  ...
                  <tr>
                    ...
                    @foreach($arr as $key => $val)
                      @if($key !== 'id')<td>{{ Str::limit((string)($val ?? '—'), 80) }}</td>@endif
                    @endforeach
                  </tr>
                @empty
                  <tr><td colspan="10" class="text-center">No reviews found.</td></tr>
                @endforelse
              </tbody>
            </table>
          </div>
