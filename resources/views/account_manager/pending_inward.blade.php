    ...
    <div class="row"><div class="full-wdt"><div class="contents-inner"><div class="row"><div class="col-12">
      <div class="section-content">
        ...
        <div class="content-head">
          <h4 class="content-title">Pending Inward</h4>
        </div>

        <div class="content-details show">
          @if($rows instanceof \Illuminate\Support\Collection && $rows->isEmpty())
            <div class="alert alert-info">No pending inward table found or no records yet.</div>
          @else
          <div class="table-responsive">
            <table class="table data-table table-striped table-bordered">
              ...
              <tbody>
                ...
                @empty
                  <tr><td colspan="10" class="text-center">No pending inward records.</td></tr>
                @endforelse
              </tbody>
            </table>
          </div>
