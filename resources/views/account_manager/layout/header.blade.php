<header class="top-header media">
    <div class="top-left mr-3">
        <a class="navbar-brand" href="{{ route('account_manager.dashboard') }}">
        ...
        <div class="right-content float-right">
            <div class="dropdown user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                    <h4 class="name">{{ Auth::guard('account_managers')->user()->name ?? 'Account Manager' }}</h4>
                </a>
                <ul class="dropdown-menu">
                    <li><a href="{{ route('account_manager.logout') }}"><i class="fa fa-power-off"></i> Logout</a></li>
                </ul>
            </div>
        </div>
    </div>
