...
<div class="content-page">
    <div class="content">
        ...
        <form method="GET" class="form-inline mb-3">
            ...
            <a href="{{ route('pos.completed_orders') }}" class="btn btn-secondary btn-sm">Reset</a>
        </form>
        <div class="table-responsive">
            <table class="table mb-0 table-bordered table-striped" id="completed_orders_table">
                <thead>
                    <tr>
                ...
                <tbody>
                    ...
                    @empty
                    <tr><td colspan="9" class="text-center">No completed orders</td></tr>
                    @endforelse
                </tbody>
            </table>
        </div>
...
@push('scripts')
<script>$(document).ready(function(){ $('#completed_orders_table').DataTable({order:[[0,'desc']], paging:false}); });</script>
@endpush
@endsection
