...
<div class="content-page">
    <div class="content">
        ...
        <form method="GET" class="form-inline mb-3">
            ...
            <a href="{{ route('pos.accepted_orders') }}" class="btn btn-secondary btn-sm">Reset</a>
        </form>
        <div class="table-responsive">
            <table class="table mb-0 table-bordered table-striped" id="accepted_orders_table">
                <thead>
                    <tr>
                ...
                <tbody>
                    ...
                    @empty
                    <tr><td colspan="9" class="text-center">No accepted orders</td></tr>
                    @endforelse
                </tbody>
            </table>
        </div>
...
@push('scripts')
<script>$(document).ready(function(){ if($('#accepted_orders_table tbody tr').length > 1) $('#accepted_orders_table').DataTable({order:[[0,'desc']]}); });</script>
@endpush
@endsection
