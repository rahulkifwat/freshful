<header class="top-header media">
    <div class="top-left mr-3">
        <a class="navbar-brand" href="{{ route('hr_manager.dashboard') }}">
        ...
        <div class="right-content float-right">
            <div class="dropdown user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                    <h4 class="name">{{ Auth::guard('hr_managers')->user()->name ?? 'HR Manager' }}</h4>
                </a>
                <ul class="dropdown-menu">
                    <li><a href="{{ route('hr_manager.profile') }}"><i class="fa fa-user"></i> My Profile</a></li>
                    <li><a href="{{ route('hr_manager.logout') }}"><i class="fa fa-power-off"></i> Logout</a></li>
                </ul>
            </div>
        </div>
    </div>
