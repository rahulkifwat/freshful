  ...
  <div class="contents-inner">
    <div class="row"><div class="full-wdt"><div class="contents-inner"><div class="row"><div class="col-12">
      <div class="section-content">
        <div class="content-head"><h4 class="content-title">Pending Orders</h4></div>
        <div class="content-details show">
          <div class="table-responsive">
            <table class="table data-table table-striped table-bordered">
              <thead>
                <tr><th>Order ID</th><th>Buyer</th><th>Phone</th><th>Total (₹)</th><th>Status</th><th>Date</th><th>Change Status</th><th>View</th></tr>
              </thead>
              <tbody>
                @forelse($orders as $o)
                  <tr>
                    ...
                    <td>
                      <select class="form-control form-control-sm change_status_order"
                              data-id="{{ $o->id }}" data-order_id="{{ $o->order_id }}" style="min-width:140px">
