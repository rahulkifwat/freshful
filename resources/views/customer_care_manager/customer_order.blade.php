...
<div class="right-panel">
    <div class="content">
        <div class="container-fluid">
            ...
            <div class="card mb-3">
                <div class="card-body">
                    <form method="GET" action="{{ route('customer_care_manager.customer_order') }}" class="form-inline">
                            ...
                            <table class="table table-hover">
                                ...
                                @foreach($orders as $order)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('customer_care_manager.view_order', ['order_id' => $order->order_id]) }}"
