        ...
        <div class="col-md-12">
          <div class="section-content">
            ...
            <div class="content-head">
              <h4 class="content-title">{{ $row ? 'Update Offer' : 'Add Offer' }}</h4>
            </div>
            ...
            <div class="content-details show">
              ...
              <div class="card pay-invoice">
                <div class="card-body">
                  <form method="post" action="{{ route('admin.home_offer_store') }}" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="row form-group">
                      ...
                      <div class="col-12 col-md-9">
                        ...
                        @if($row && !empty($row->image))
                          <div class="mt-2">
                            <img src="{{ asset('uploads/images/offers/'.$row->image) }}" height="80" alt="" />
                    ...
                    <div class="card-footer">
                      ...
                      <a href="{{ route('admin.home_offers') }}" class="btn btn-secondary btn-sm">Cancel</a>
                    </div>
                  </form>
                </div>
              </div>
