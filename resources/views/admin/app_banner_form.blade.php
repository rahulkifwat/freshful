        ...
        <div class="col-md-12">
          <div class="section-content">
            ...
            <div class="content-head">
              <h4 class="content-title">{{ $row ? 'Update App Banner' : 'Add App Banner' }}</h4>
            </div>
            ...
            <div class="content-details show">
              ...
              <div class="card pay-invoice">
                <div class="card-body">
                  <form method="post" action="{{ route('admin.app_banner_store') }}" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="card-footer">
                      ...
                      <a href="{{ route('admin.app_banners') }}" class="btn btn-secondary btn-sm">Cancel</a>
                    </div>
                  </form>
                </div>
              </div>
