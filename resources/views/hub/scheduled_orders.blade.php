        ...
        <div class="container-fluid">
            <div class="page-header">
                <div class="row align-items-center">
                    <div class="col-auto">
                        <h3 class="page-title">Scheduled Orders</h3>
                        <ul class="breadcrumb">
            ...
            <div class="card">
                <div class="card-header"><h4 class="card-title">Scheduled Orders</h4></div>
                <div class="card-body">
                    @if($orders->isEmpty())
                        <div class="alert alert-info">No scheduled orders.</div>
                    @else
                        <div class="table-responsive">
                            <table class="table table-hover">
                                <thead>
                                    <tr><th>Order ID</th><th>Buyer</th><th>Phone</th><th>Total (₹)</th><th>Scheduled Date</th><th>Status</th><th>Action</th></tr>
                                </thead>
                                <tbody>
