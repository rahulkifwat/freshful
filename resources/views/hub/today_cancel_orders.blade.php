        ...
        <div class="container-fluid">
            <div class="page-header">
                <div class="row align-items-center">
                    <div class="col-auto">
                        <h3 class="page-title">Today's Cancelled Orders</h3>
                        <ul class="breadcrumb">
            ...
            <div class="card">
                <div class="card-header"><h4 class="card-title">Cancelled — {{ now()->format('d M Y') }}</h4></div>
                <div class="card-body">
                    @if($orders->isEmpty())
                        <div class="alert alert-info">No cancelled orders today.</div>
                    @else
