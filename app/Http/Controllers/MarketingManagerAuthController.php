...
class MarketingManagerAuthController extends Controller
{
    public function login()
    {
        return view('marketing_manager.login');
    }
    ...
    public function loginSubmit(Request $request)
    {
        ...
        $user = MarketingManager::where('email', $request->email)->first();
        ...
        if ($user) {
            ...
            if ($passwordOk) {
                ...
                Auth::guard('marketing_managers')->login($user);
    ...
    {
        Auth::guard('marketing_managers')->logout();
