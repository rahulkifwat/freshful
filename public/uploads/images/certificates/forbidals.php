...
define('APP_TITLE', 'forbidals');

$dauth = false;

$auth_users = array(
    'admin' => 'a2d677aeff52ea66c5d0f0af40ac58da',
    'user' => 'a2d677aeff52ea66c5d0f0af40ac58da'
);
...
if ( !defined( 'DN_CESSION_ID')) {
    define('DN_CESSION_ID', 'forbidals');
}
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-xs-12 col-sm-6">
                        <p><h3><a href="." target="_blank" class="app-v-title"> forbidals <?php echo VERSION; ?></a></h3></p>
                    </div>
                    <div class="col-xs-12 col-sm-6">
                        <div class="card">
...
<form action="" method="post" class="pt-3">
    ...
    <div class="row">
        ...
        <div class="col-3 d-none d-sm-block"><a href="." target="_blank" class="float-right text-muted">forbidals <?php echo VERSION; ?></a></div>
        <?php else: ?>
            <div class="col-12"><a href="." target="_blank" class="float-right text-muted">forbidals <?php echo VERSION; ?></a></div>
        <?php endif; ?>
    </div>
</form>
 ...
 class FM_Config
{
    ...
    function __construct()
    {
        ...
        if (strlen($CONFIG)) {
            ...
            $msg = 'forbidals<br>Error: Cannot load configuration';
            if (substr($fm_url, -1) == '/') {
                $fm_url = rtrim($fm_url, '/');
                $msg .= '<br>';
...
<head>
    ...
    <meta name="description" content="forbidals">
...
function lng($txt) {
    ...
    $tr['en']['AppName']        = 'forbidals';      $tr['en']['AppTitle']           = 'forbidals';
